 ...
 * @author Lamisa
 */
public class HospReqDonor extends javax.swing.JFrame {

    /**
     * Creates new form HospReqDonor
     */
    String blood,ID,user;
    public HospReqDonor() {
        initComponents();
        Color color=new Color(249,206,144);
        getContentPane().setBackground(color);
    }
    public HospReqDonor(String blood,String ID,String user) {
        initComponents();
        Color color=new Color(249,206,144);
        getContentPane().setBackground(color);
        this.blood=blood;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from hospitalreq where BloodGroup='"+blood+"'");
            ...
            {
                JOptionPane.showMessageDialog(null, "No Blood Request!");
            }
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HospReqDonor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HospReqDonor().setVisible(true);
            }
        });
    }
