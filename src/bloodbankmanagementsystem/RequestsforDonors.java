 ...
 * @author Lamisa
 */
public class RequestsforDonors extends javax.swing.JFrame {

    /**
     * Creates new form RequestsforDonors
     */
    public RequestsforDonors() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 690, 380));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, -1, -1));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 710, -1));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bloodbankmanagementsystem/icons8_hospital_sign_16px.png"))); // NOI18N
        jButton2.setText("HOSPITAL REQUESTS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RequestsforDonors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new RequestsforDonors().setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
            }
        });
    }
